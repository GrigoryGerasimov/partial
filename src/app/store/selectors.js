...
export const receiveAllSocialnets = () => state => state.socialnets.entities ? state.socialnets.entities.payload : null;
export const receiveSocialnetById = id => state => state.socialnets.entities.payload ? state.socialnets.entities.payload.find(entity => entity._id === id) : null;
