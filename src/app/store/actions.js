...
export const asyncTeammatesActions = {
    ...
    receiveAsyncTeammateById: createAsyncThunk("teammates/receiveTeammateById", async({ id }, thunkApi) => {
        try {
    ...
    createAsyncTeammates: createAsyncThunk("teammates/createTeammates", async({ data }, thunkApi) => {
        try {
    ...
    updateAsyncTeammate: createAsyncThunk("teammates/updateTeammate", async({ id, data }, thunkApi) => {
        try {
    ...
    removeAsyncTeammate: createAsyncThunk("teammates/removeTeammate", async({ id }, thunkApi) => {
        try {
...
export const asyncHobbiesActions = {
    ...
    receiveAsyncHobbyById: createAsyncThunk("hobbies/receiveHobby", async({ id }, thunkApi) => {
        try {
    ...
    createAsyncHobbies: createAsyncThunk("hobbies/createHobbies", async({ payload }, thunkApi) => {
        try {
    ...
    updateAsyncHobby: createAsyncThunk("hobbies/updateHobby", async({ id, payload }, thunkApi) => {
        try {
